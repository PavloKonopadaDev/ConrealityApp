...
child: IconButton(onPressed: (){updateTabSelection(0);}, 
icon:Icon(Icons.panorama_fish_eye,color:colorForBottomIcons))),
...
width: ScreenUtil().setWidth(37),
height: ScreenUtil().setHeight(40),
child: IconButton(onPressed: (){updateTabSelection(1);},
icon:Icon(Icons.panorama_fish_eye,color: colorForBottomIcons))),
...
width: ScreenUtil().setWidth(37),
height: ScreenUtil().setHeight(40),
child: IconButton(onPressed: (){updateTabSelection(2);},
icon:Icon(Icons.panorama_fish_eye,color:colorForBottomIcons))),
...
icon: Container(width: ScreenUtil().setWidth(37),
height: ScreenUtil().setHeight(40),
child: IconButton(onPressed: (){updateTabSelection(3);},
icon:Icon(Icons.panorama_fish_eye,color: colorForBottomIcons))),
